...
function TestTable1(){
	$('#datatable-1').dataTable( {
		"aaSorting": [[ 0, "asc" ]],
		"sDom": "<'box-content2'<'col-sm-6'f><'col-sm-6 text-right'l><'clearfix'>>rt<'box-content3'<'col-sm-6'i><'col-sm-6 text-right'p><'clearfix'>>",
	...
	var calendar = $('#calendar').fullCalendar({
		...
		eventClick: function(calEvent, jsEvent, view) {
			...
			var buttons = $('<button id="event_cancel" type="cancel" class="btn btn-default btn-label-left">'+
							...
							'Cancel'+
							'</button>'+
							'<button id="event_delete" type="cancel" class="btn btn-primary btn-label-left">'+
							'<span><i class="fa fa-clock-o txt-danger"></i></span>'+
							'Delete'+
							'</button>'+
