<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" Theme="Default" StylesheetTheme="Default" CodeFile="Registrar_Approval.aspx.cs" Inherits="_DBRegistrar" %>
            ...
            <asp:GridView runat="server" ID="gvForms" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Created Date" DataField="CreatedDate" DataFormatString="{0:dd/MM/yyyy hh:mm:ss}" />
                               <asp:TemplateField HeaderText="Registrar Decision">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                       ...
                       <asp:LinkButton CssClass="loadiframe" CommandName="save" CommandArgument='<%# Eval("RequestId") %>' runat="server" ID="btnSave"> <i class="fa fa-save fa-lg" title="Save"></i>
                        ...
                        <ItemStyle Width="200px" />
                                           ...
                                           <%--DOWNLOAD PERSONAL PHOTO--%> 

                      <asp:TemplateField HeaderText="Personal Picture">
                        <ItemTemplate>
                            <asp:LinkButton CommandName="downloadPic" CommandArgument='<%# Eval("RequestId") %>' runat="server" ID="btndownloadPic" Visible="true"> <i class="fa fa-download" title="download"></i>
                            </asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle Width="75px" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Comments">
                        <ItemTemplate>
                          <asp:LinkButton CommandName="comment" CommandArgument='<%# Eval("RequestId") %>' runat="server" ID="btnComment" OnClientClick="clickbtn2(this);" data-Detailid='<%# Eval("RequestId") %>' data-faid='<%# Eval("FormApprovalId") %>'> <i class="fas fa-comment-alt fa-lg"  title="Comments"></i>
                            </asp:LinkButton>
