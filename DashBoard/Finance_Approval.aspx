<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" Theme="Default" StylesheetTheme="Default" CodeFile="Finance_Approval.aspx.cs" Inherits="_DBFinance" %>
            ...
            <asp:GridView runat="server" ID="gvForms" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Created Date" DataField="CreatedDate" DataFormatString="{0:dd/MM/yyyy hh:mm:ss}" />
                               <asp:TemplateField HeaderText="Finance Decision">
                        <ItemTemplate>
