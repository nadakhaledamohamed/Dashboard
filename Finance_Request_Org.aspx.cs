    ...
    protected void gvForms_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        switch (e.Row.RowType)
        {
            case DataControlRowType.DataRow:
                ...
                if (myDataRowView["payment_status"].ToString().ToLower() == "true" || int.Parse(myDataRowView["Processing_Status"].ToString().ToLower())!=2)
                {
                ...
                if (int.Parse(myDataRowView["Processing_Status"].ToString().ToLower()) ==2)
                {
